...
<p>The study notes that the tiny random differences typical of Turing patterns add to the uniqueness of fingerprints. Identical twins share their genes, and their fingerprints often share a type, but not the details: in one large study twins’ prints had the same type about three times in four, yet a fingerprint matcher could still tell them apart. “Grow again” keeps the plan and changes only the tiniest details, and you can watch the ridges end and fork in new places.</p>
...
<details><summary>The mathematics, if you want it</summary><p>The two signals a (activator) and h (inhibitor) follow a cubic form of the Barrio–Varea–Aragón–Maini model: ∂a/∂t = 0.45 s ∇²a + 0.899 a − h − 3.15 a h², and ∂h/∂t = s ∇²h + 0.899 a − 0.91 h − 3.15 a h². The even state a = h = 0 is unstable to ripples of one wavelength (about 9.5√s grid cells), but it stays exactly even until a site nudges it, so ridges spread only as waves from the sites. With no squared terms, stripes win over spots. The ridge spacing slider changes s.</p><p>The room names the result by walking around each point where the ridge direction breaks down and adding up how far the direction turns (its Poincaré index): half a turn one way for a loop’s core, a whole turn for a whorl’s centre, and half a turn the other way for a triradius. Fingerprint examiners use the same landmarks. Points right at the edge of the fingertip are missed.</p></details>
<div class="sources"><a class="source-link" href="https://www.research.ed.ac.uk/en/publications/the-developmental-basis-of-fingerprint-pattern-formation-and-vari/" target="_blank" rel="noopener">Glover et al. (2023), The developmental basis of fingerprint pattern formation and variation</a><a class="source-link" href="https://doi.org/10.1098/rstb.1952.0012" target="_blank" rel="noopener">Turing (1952), The chemical basis of morphogenesis</a><a class="source-link" href="https://doi.org/10.1371/journal.pone.0035704" target="_blank" rel="noopener">Tao et al. (2012), Fingerprint recognition with identical twin fingerprints</a><a class="source-link" href="https://doi.org/10.1006/bulm.1998.0093" target="_blank" rel="noopener">Barrio et al. (1999), where these equations come from</a></div>`,
  },
});
