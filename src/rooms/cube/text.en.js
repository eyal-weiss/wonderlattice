...
Wonderloom.defineText('cube', 'en', {
  ...
  tip: 'Drag to turn the view · Arrow keys work too',
  actionLabel: 'Repeat it',
  actionCompare: 'Turn them',
  canvasLabel: 'A Rubik’s Cube. Use the move buttons to turn its faces; drag or use the arrow keys to turn the view.',
  ...
  insight: {
    ...
    html: `<p>Think of a cube move as a rule: every sticker goes to a new place. Doing one move after another combines two rules into a new one. Every move can be undone. And doing nothing at all is a move too. Mathematicians call a collection like this a <em>group</em>.</p>
...
<div class="sources"><a class="source-link" href="https://en.wikipedia.org/wiki/Rubik%27s_Cube_group" target="_blank" rel="noopener">The Rubik’s Cube group</a><a class="source-link" href="https://www.cube20.org/" target="_blank" rel="noopener">God’s number is 20</a><a class="source-link" href="https://mathshistory.st-andrews.ac.uk/Biographies/Galois/" target="_blank" rel="noopener">Évariste Galois</a></div>`,
  },
});
