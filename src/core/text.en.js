...
Wonderloom.defineText('app', 'en', {
  ...
  stage: {
    ...
    linkCopied: 'Exploration link copied. The recipient needs site access.',
    settingsCopied: 'Exploration settings copied.',
    linkDescription: 'Copy this link to reopen these settings. The recipient needs access to the site.',
  ...
  guests: {
    eyebrowPortrait: 'Math history · historical portrait',
    eyebrowSketch: 'Math history · a playful sketch',
    story: 'Story ↗',
    storyLabel: (name) => `Read about ${name}`,
    portrait: 'Portrait ↗',
    portraitLabel: (name) => `Portrait source for ${name}`,
  ...
  trail: {
    ...
    tooLarge: 'Choose a Wonderloom trail export smaller than 2 MB.',
