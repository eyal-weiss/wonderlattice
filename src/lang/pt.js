...
Wonderlattice.defineText('sudoku', 'pt', {
  ...
  guest: {
    name: 'Leonhard Euler',
    note: 'Um Sudoku terminado é um quadrado latino com uma regra a mais para as regiões. Meus 36 oficiais precisavam de dois quadrados latinos ao mesmo tempo, o que se mostrou impossível.',
  },
  insight: {
