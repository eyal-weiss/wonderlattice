...
Wonderlattice.defineText('sudoku', 'es', {
  ...
  guest: {
    name: 'Leonhard Euler',
    note: 'Un sudoku terminado es un cuadrado latino más una regla para los bloques. Mis 36 oficiales necesitaban dos cuadrados latinos a la vez, y resultó imposible.',
  },
  insight: {
